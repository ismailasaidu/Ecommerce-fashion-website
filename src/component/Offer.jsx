  ...
  return (
    ...
    <div>
      <div className="flex gap-[40px] pl-14 pr-14 mt-[80px]">
        <div className="grow-[2] bg-black text-center h-[380px] py-[120px]">
          ...
          <button className="text-blue-400 bg-white h-[40px] w-[150px] mt-[20px]"
          onClick={Goto}>
            BUY NOW
          </button>
        </div>
        <div className="grow-[0.5] bg-black text-center h-[380px] py-[120px]">
          ...
          <button className="text-blue-400 bg-white h-[40px] w-[150px] mt-[20px]" onClick={Goto}>
            BUY NOW
          </button>
        </div>
      </div>
